...
export const RADAR_ITEMS: RadarItem[] = [
  {
    ...
    metricIds: ["m2", "china-m2", "japan-m2", "euro-m2", "india-broad-money", "global-liq", "fed"],
    chartFocus: "US/China/Japan/Euro M2, India broad money, broad liquidity, Fed funds",
  },
  {
    id: "rates-yields",
    title: "Rates & Yield Pressure",
    why: "Long rates influence equity multiples, credit creation, mortgages, and the cost of capital.",
    metricIds: ["us2y", "us10y", "us20y", "fed", "dxy"],
    chartFocus: "US 2Y, 10Y, 20Y, policy rates, dollar",
  },
  {
  ...
  },
  {
    ...
    why: "Copper, gold, oil, iron ore, lithium, uranium, and miners help reveal whether markets are pricing growth, inflation, or stress.",
    metricIds: ["copper", "gold", "oil", "iron", "lithium", "sprott-uranium", "bhp"],
    chartFocus: "Copper, gold, crude, iron ore, lithium, uranium, miners",
  },
  {
    ...
    metricIds: ["vix", "btc", "semi-nvda"],
    chartFocus: "VIX, BTC, high-beta semiconductors",
  },
];
